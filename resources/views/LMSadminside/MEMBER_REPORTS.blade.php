...
<body class="bg-gray-100 h-full">
    ...
    // Manually highlight the Member Reports link if the path is 'MEMBER_REPORTS'
    if (path.includes('MEMBER_REPORTS')) {
        const memberReportsLink = document.getElementById('member_reports');
        memberReportsLink.classList.add('active');
    }
</script>
