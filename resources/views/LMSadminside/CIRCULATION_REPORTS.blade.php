...
<body class="bg-gray-100 h-full">
        ...
        <main class="flex-1 bg-gray-100 ml-72 overflow-y-auto">
            ...
            <section class="bg-gray-100 fixed px-11 py-6 w-full top-14">
                <p class="text-sm text-gray-600">
                    ...
                    Circulation Reports / My Settings
                </p>
            </section>
    ...
    // Manually highlight the Circulation Reports link if the path is 'CIRCULATION_REPORTS'
    if (path.includes('CIRCULATION_REPORTS')) {
        const circulationReportsLink = document.getElementById('circulation_reports');
        circulationReportsLink.classList.add('active');
    }
</script>
