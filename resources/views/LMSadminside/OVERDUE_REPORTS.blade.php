...
<body class="bg-gray-100 h-full">
    ...
    // Manually highlight the Overdue Reports link if the path is 'OVERDUE_REPORTS'
    if (path.includes('OVERDUE_REPORTS')) {
        const overdueReportsLink = document.getElementById('overdue_reports');
        overdueReportsLink.classList.add('active');
    }
</script>
