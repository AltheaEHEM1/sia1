...
<body class="bg-gray-100 h-full">
    ...
    // Manually highlight the Circulations link if the path is 'CIRCULATION'
    if (path.includes('CIRCULATION')) {
        const circulationsLink = document.getElementById('circulation');
        circulationsLink.classList.add('active');
    }
</script>
