...
<body class="bg-gray-100 h-full">
    ...
    // Manually highlight the Cataloger link if the path is 'CATALOGER'
    if (path.includes('CATALOGER')) {
        const catalogerLink = document.getElementById('cataloger');
        catalogerLink.classList.add('active');
    }
</script>
