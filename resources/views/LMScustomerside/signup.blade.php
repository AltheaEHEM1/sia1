            ...
            <form action="{{ route('register.step.one') }}" method="POST" class="space-y-6">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
                        <div>
                            ...
                            <input type="text" id="firstName" name="firstName" class="w-full border border-gray-300 rounded-md p-2 focus:ring-2 focus:ring-blue-500 focus:outline-none" required>
                        </div>
