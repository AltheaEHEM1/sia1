...
<body class="bg-gray-100">
    <div class="flex h-screen">
        <!-- Sidebar -->
        <aside class="sidebar bg-[#012A4A] text-white flex flex-col">
                <div class="p-5">
                <!-- Logo -->
                ...
                <!-- Navigation Menu -->
                <ul class="mt-8"> 
                    <li><a href="#" class="flex items-center py-3 px-6 hover:bg-[#028ABE] hover:text-white rounded-lg transition-all duration-200 ease-in-out">
        ...
        <main class="flex-1">
                <!-- Header -->
                <header class="flex items-center justify-between bg-gray-200 px-12 py-4 shadow-sm">
                    <h1 class="text-lg font-semibold text-gray-800">Novella Library</h1>
                    <div class="flex items-center space-x-4"> <!-- Added flexbox and spacing -->
                        <!-- Bell Icon -->
                ...
                <!-- Direction of Tabs -->
                <section class="bg-gray-100 px-12 py-4"> <!-- Padding applied to left and right -->
                ...
                <!-- Content Placeholder -->
                <div class="bg-gray-50 flex-5 px-12 py-10 border-2">
    ...
    // Redirect to Settings page and close dropdown
    settingsLink.addEventListener('click', (event) => {
        event.preventDefault(); // Prevent default link action
        dropdownMenu.classList.add('hidden'); // Close the dropdown
    });

    // Redirect to Logout page and close dropdown
